                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        className="w-full flex flex-col items-center gap-1.5 p-2 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-[var(--accent-color)]/50 hover:bg-[var(--percent-bg)]/30 transition-all cursor-pointer group"
                      >
                        <BankLogo 
                          bank={bank} 
