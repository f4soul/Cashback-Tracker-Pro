          ...
          <div className="flex items-center justify-between mb-4 px-1 gap-2 flex-wrap">
            <div className="flex items-center gap-2 flex-wrap flex-1 min-w-0">
              {isAfter25 && allMonthIds.length > 1 ? (
                <>
                  <div className="flex bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl p-0.5 shrink-0 [.pdf-export-mode_&]:hidden border border-slate-200/50 dark:border-white/10 shadow-sm translate-z-0 [backface-visibility:hidden]">
                    {allMonthIds.map((mId) => (
                      <button
                        key={mId}
