...
export default function App() {
  ...
  const AuthButton = ({ isMobile = false }) => {
    if (user) {
      return (
        <div
          className={clsx('flex items-center', isMobile ? 'gap-1' : 'w-full')}
        >
          <div
    ...
    return (
      ...
      >
        ...
        <span
          className={isMobile ? 'text-[10px] uppercase tracking-wider' : ''}
        >
          Войти
        </span>
      </button>
  ...
  const currentMonthData = useMemo(
    () =>
      allData.find((d) => d.monthId === currentMonthId) || {
  ...
  return (
    ...
    >
      ...
      <main
        ...
        className="flex-1 overflow-y-auto scrollbar-hide app-content-text pt-[86px] pb-[100px] md:pt-12 md:pb-12 relative"
      >
          ...
          {activeTab === 'current' ? (
            <CurrentMonth
              ...
              onDeleteEntry={(entryId) =>
                deleteMonthEntry(currentMonthId, entryId)
              }
