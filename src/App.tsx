...
export default function App() {
  ...
  const currentMonthData = useMemo(() => 
    allData.find(d => d.monthId === currentMonthId) || { monthId: currentMonthId, entries: [] },
  ...
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <main id="main-scroll-container" className="flex-1 overflow-y-auto scrollbar-hide app-content-text pt-[86px] pb-[100px] md:pt-12 md:pb-12 relative">
        <div className="max-w-4xl lg:max-w-[700px] mx-auto px-3 sm:px-6 lg:px-8 pt-0 pb-3 lg:pt-0 lg:pb-8">
          {activeTab === 'current' ? (
            <CurrentMonth 
